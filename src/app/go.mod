...
replace realworld/user => ../user

replace realworld/utils => ../utils

require (
	realworld/user v0.0.0-00010101000000-000000000000
	realworld/utils v0.0.0-00010101000000-000000000000
)
